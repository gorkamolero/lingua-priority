...
[![tests](https://img.shields.io/badge/tests-48%20passed-brightgreen)](https://github.com/gorkamolero/lingua-priority)
...
- Move or mirror the repo from `gorkamolero` to `gorkamolero`.
...
MIT © [Gorka Molero](https://github.com/gorkamolero)
